        ...
        <div class="privacy">
          ...
          <p>
            <span class="tsmcontroller"
              >Hauke Brinkmann<br />
              Heinrich-Gefken-Straße 7<br />
              28359 Bremen<br />
              h.brinkmann@reply.de</span
            >
          </p>
          ...
          <p>
            <strong
              ...
              Zwecke der Direktwerbung erfolgen.</strong
            >
          </p>
          ...
          <p>
            <span class="ts-muster-content"
              ...
              dennoch Hilfe benötigen, dann können Sie sich an uns wenden.<br />
              <br />
          ...
          <p>
            <span class="ts-muster-content"
              ...
              ein. Nach Angaben von Google werden die Daten der Nutzer allein zu
              Zwecken der Darstellung der Schriftarten im Browser der Nutzer
              verwendet. Die Einbindung erfolgt auf Grundlage unserer
          ...
          <p>
            <span class="ts-muster-content"
              >Wir binden die Landkarten des Dienstes "OpenStreetMap" ein (<a
                target="_blank"
          ...
          <p>
            <span class="ts-muster-content"
              ...
              dieses Onlineangebotes innerhalb von Twitter teilen können.<br />
